#!/usr/bin/env python3
"""PU2PNY 0.3.21 DMRGateway voice arbiter.
...
{
\treturn m_status == XLXVOICE_STATUS::SENDING;
}
...
{
\treturn m_slot == slot && m_status == DYNVOICE_STATUS::SENDING;
}
