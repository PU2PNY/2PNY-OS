...
# SEC-025: radio-admin request path + hardened one-shot executor + patched gateway.
...
# Binary must come from the pinned DStarGateway source patched at build time.
...
echo "PU2PNY-OS 0.3.17-alpha ARM64 image: D-Star/timezone focused structural gates OK — hardware validation still required"
