...
VERSION="${2:-0.3.8-alpha}"
RAW="/tmp/PU2PNY-${VERSION}-validate-038.img"
ROOT="/mnt/pu2pny-os-038"
LOOP=""; PID=""
cleanup(){
  set +e
...
echo "PU2PNY-OS $VERSION ARM64 image: 0.3.7 regressions + 0.3.8 corrective SW/structural gates OK — hardware validation still required"