...
strings "$ROOT/usr/local/bin/2pnyd" | grep -Fq '0.3.16-alpha'
test "$(cat "$ROOT/etc/2pny/version")" = "0.3.16-alpha"

echo "PU2PNY-OS 0.3.16-alpha ARM64 image: focused bugfix structural gates OK — HW validation still required"
