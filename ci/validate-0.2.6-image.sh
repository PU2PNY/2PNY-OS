...
for needle in 'RX · Rádio → hotspot' 'TX · Rede → rádio' 'MTR / qualidade' 'Internet e rede local' 'DMRGateway' 'MMDVM-Display' '@media(max-width:760px)'; do grep -Fq "$needle" "$DASH"; done
...
echo "$STATUS" | grep -Fq '"version":"0.2.6-alpha"'
