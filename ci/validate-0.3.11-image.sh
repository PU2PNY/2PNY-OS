...
strings "$ROOT/usr/local/bin/2pnyd" | grep -Fq '0.3.11-alpha'
...
echo '[14e/15] 0.3.11 inherited display/protocol/network hardening gates'
...
echo '[14f/15] 0.3.11 MMDVM/i18n regression gates'
...
echo "PU2PNY-OS $VERSION ARM64 image: inherited regressions + 0.3.11 corrective SW/structural gates OK — hardware validation still required"