...
VERSION="${2:-0.3.27-alpha}"
REPO="$(cd "$(dirname "$0")/.." && pwd)"
RAW="/tmp/PU2PNY-${VERSION}-validate-0327.img"
ROOT="/mnt/pu2pny-os-0327"
LOOP=""; PID=""
cleanup(){
  set +e
...
printf '%s\n' 'NEVERRETURNME-0327' > "$ROOT/var/lib/2pny/protocol-secrets/dmr.secret"
...
! echo "$BMJSON" | grep -Fq 'NEVERRETURNME-0327'
curl -fsS http://127.0.0.1/api/config | grep -vq 'NEVERRETURNME-0327'
