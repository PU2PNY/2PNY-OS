...
strings "$ROOT/usr/local/bin/2pnyd" | grep -Fq '0.3.24-alpha'
...
echo "PU2PNY-OS $VERSION ARM64 image: SW/structural gates PASS; RF/Nextion/Direct A↔B and CGNAT behavior remain HW PENDING"
