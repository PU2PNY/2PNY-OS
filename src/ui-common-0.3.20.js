(function(){
  ...
  function sweepRealOnly(root){(root||document).querySelectorAll('[data-real-only]').forEach(function(n){var v=n.querySelector('b,code,[data-real-value]')||n;realOnly(v)})}
