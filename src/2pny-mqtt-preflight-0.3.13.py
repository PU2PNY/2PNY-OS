#!/usr/bin/env python3
"""PU2PNY-OS 0.3.13 MQTT protocol readiness gate.
...
def main():
    ...
    # RF bootstrap MQTTLevel=0 by design, so the radio engine must be allowed
    # to prove UART ownership without requiring the event bus first.
