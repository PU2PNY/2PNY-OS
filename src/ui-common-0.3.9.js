(function(){
  ...
  function ensureGlobalCSS(){
    ...
    st.textContent='.topnav{min-height:52px;height:auto;padding-top:7px;padding-bottom:7px}.topnav .nav{min-width:0;overflow-x:auto;flex-wrap:nowrap;scrollbar-width:thin}.topnav .nav a{white-space:nowrap;flex:0 0 auto;padding:7px 9px;font-size:13px}.navtools{flex:0 0 auto;white-space:nowrap}.navtools .pill,#clockLocal{white-space:nowrap;min-width:72px}.pny-health{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin:10px 0 4px}.pny-healthitem{padding:9px 10px;border:1px solid var(--line);border-radius:10px;background:var(--card2);min-width:0}.pny-healthitem .big{font-size:18px}.pny-meter{height:7px;border-radius:999px;background:var(--line);overflow:hidden;margin-top:6px}.pny-meter i{display:block;height:100%;background:var(--blue);width:0}.pny-profiledetails{margin-top:7px}.pny-profiledetails summary{cursor:pointer;color:var(--muted);font-size:12px;font-weight:850}.pny-profilebar{display:flex;gap:6px;flex-wrap:wrap;margin:8px 0 0}.pny-profilebar .btn{padding:6px 9px;font-size:12px}.pny-profilebar button.active{outline:2px solid var(--green)}.pny-protocol-frame{width:100%;height:980px;border:0;border-radius:14px;background:var(--card)}@media(max-width:760px){.pny-health{grid-template-columns:1fr 1fr}.topnav{align-items:flex-start}.navtools{margin-left:auto}.pny-protocol-frame{height:1200px}}@media(max-width:480px){.pny-health{grid-template-columns:1fr}}';
  ...
  function enhanceHotspot(){
    ...
    var top=main.querySelector('.top');if(top&&top.nextSibling)main.insertBefore(sec,top.nextSibling);else main.insertBefore(sec,main.firstChild);
  }
