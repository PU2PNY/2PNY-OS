/* PU2PNY-OS 0.3.8 UI translation layer (PT/EN/ES): exact catalog + guarded phrase fallback. */
(()=>{
const D={
...
[/\bOcultar\b/gi,'Hide'],[/\bDetectado\b/gi,'Detected'],[/\bDetectar\b/gi,'Detect'],[/\bTempo\b/gi,'Time'],[/\bLocal\b/gi,'Local']
],
es:[
...
[/\bDesligado\b/gi,'Apagado'],[/\bIdioma\b/gi,'Idioma'],[/\bHistórico\b/gi,'Historial'],[/\bProtocolos\b/gi,'Protocolos'],[/\bAo Vivo\b/gi,'En vivo']
]};
function tx(text){
